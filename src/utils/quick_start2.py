...
def quick_start(model, dataset, config_dict, save_model=True, mg=False):
    ...
    for hyper_tuple in combinators:
        ...
        logger.info('best test during training: {}'.format(dict2str(best_test_result)))
        logger.info(
            '████Current BEST████:\nParameters: {}={},\nValid: {},\nTest: {}\n\n\n'.format(
    ...
    # ======= Final Summary =======
    logger.info('\n============All Over=====================')
    for (p, k, v,t) in hyper_ret:
        logger.info('Parameters: {}={},\n best valid: {},\n best test: {}\n best_test_overall: {}'.format(
            config['hyper_parameters'], p, dict2str(k), dict2str(v), dict2str(t)
        ))
